...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  private:
    ...
    GLuint colFocusLoc, posFocusLoc,llumAmbientLoc,  tipusCoordFocusLoc;
    ...
    typedef enum{SCA, SCO, SCM} TipusCoordFocus;
    TipusCoordFocus tipusCoordFocus;
    
public slots:
    void actualitzaFocus(int);
